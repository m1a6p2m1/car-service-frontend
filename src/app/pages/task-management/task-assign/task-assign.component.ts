...
export class TaskAssignComponent implements OnInit{
  ...
  tasks: Task[] = [
    {value: 'Normal_Car_Wash', viewValue: 'Normal Car Wash', subtasks: ['Assign Washing Bay','Wash the Vehicle','Complete the Washing Process']},
    {value: 'Pick-up_and_Drop-off_Car_wash', viewValue: 'Pick-up/Drop-off Car wash', subtasks: ['Pick-up Vehicle to the Service Center','Assign Washing Bay','Wash the Vehicle','Complete the Washing Process','Drop-off the vehicle']},
    {value: 'Remote_Car_Wash', viewValue: 'Remote Car Wash', subtasks: ['Assign Washing Bay','Wash the Vehicle','Complete the Washing Process']},
    {value: 'Remote_Maintain_Service', viewValue: 'Remote Maintain Service', subtasks: ['Assign Washing Bay','Wash the Vehicle','Complete the Washing Process']},
  ];
    ...
    try{
      ...
      if (this.mode === 'add') {
        ...
        this.taskAssignService.editData(this.selectData.taskId, formData).subscribe({
          next:(response:any)=>{
              let elementIndex = this.dataSource.data.findIndex((element)=> element.taskId === this.selectData?.taskId);
  ...
  ngOnInit(): void{
    ...
    this.taskAssignForm.get('taskName')?.valueChanges.subscribe(selectedTask => {
